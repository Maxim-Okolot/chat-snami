...
$().ready(function() {  
	// РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РґР»СЏ РІСЃРµС… СЌР»РµРјРµРЅС‚РѕРІ СЃ Р°С‚СЂРёР±СѓС‚РѕРј title. 
	// РР·РјРµРЅРёС‚Рµ РЅР° ".class[title]" РґР»СЏ РІС‹Р±РѕСЂР° С‚РѕР»СЊРєРѕ СЌР»РµРјРµРЅС‚РѕРІ СЃ РєР»Р°СЃСЃРѕРј .class Рё Р°С‚СЂРёР±СѓС‚РѕРј title
	$("[title]").style_my_tooltips({ 
		tip_follows_cursor: "on", //РІРєР»СЋС‡РёС‚СЊ/РІС‹РєР»СЋС‡РёС‚СЊ РїСЂРёРІСЏР·РєСѓ Рє РєСѓСЂСЃРѕСЂСѓ РјС‹С€Рё
		tip_delay_time: 500 //РјРёР»Р»РёСЃРµРєСѓРЅРґС‹
	});  
});  
